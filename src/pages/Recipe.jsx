...
import DetailRecipe from "../components/cards/DetailRecipe";
import Ingredients from "../components/cards/Ingredients";
  ...
  return (
    <React.Fragment>
      ...
      <div className="max-w-7xl mx-auto px-4 gap-7 sm:px-6 my-7 grid grid-cols-1 md:grid-cols-11">
        <div className="md:col-span-6 col-span-1 relative rounded-md hover:shadow-lg hover:drop-shadow-lg">
          <div className="absolute top-0  bottom-0 left-0 right-0 hover:block opacity-0 hover:opacity-100 transform hover:translate-y-0 -translate-y-4 transition-all  duration-300 cursor-pointer text-white">
            <div className="bg-gray-800 rounded-t-md bg-opacity-40 p-2">
